          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                buildInput("Email",controllerEmail,FeatherIcons.mail,TextInputType.emailAddress,false),
                buildInput("Password",controllerPassword,Icons.password_rounded,TextInputType.visiblePassword,true),
                buildInput("Confirm Password",controllerConfirmPassword,Icons.password_rounded,TextInputType.visiblePassword,false),
                Gap(),
                AnimationWidget(
                  isUp: true,
                  delay: 100,
